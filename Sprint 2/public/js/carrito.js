...
function updateShoppingCartTotal() {
  ...
  shoppingCartItems.forEach((shoppingCartItem) => {
    ...
    const shoppingCartItemPrecio = shoppingCartItemPrecioElement.textContent
      ;


    console.log ('aca : updateShoppingCartTotal -> shoppingCartItemPrecio ' , shoppingCartItemPrecio)
